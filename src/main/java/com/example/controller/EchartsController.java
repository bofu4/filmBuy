...
public class EchartsController {
    ...
    Result<List<EchartsData>> getShoppingEchartsData() {
        ...
        getPieData("Total sales by category", list, typeMap);
        getBarData("Total sales by category", list, typeMap);
    ...
    Result<List<EchartsData>> getPriceEchartsData() {
        ...
        getPieData("Total sales revenue by category", list, typeMap);
        getBarData("Total sales revenue by category", list, typeMap);
        return Result.success(list);
    }
    ...
    private void getPieData(String name, List<EchartsData> pieList, Map<String, Double> dataMap) {
        ...
        series.setName(name + " proportion");
        series.setType("pie");
        series.setRadius("55%");
